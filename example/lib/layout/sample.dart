...
class Sample extends StatelessWidget {
  ...
  Sample(this.title,
      ...
      : this.showPadding = showPadding,
        this.describe = describe is String ? describe : "",
        this.child = child is Widget ? child : Container(),
        this.color = color;
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> children = [
      //  head
      Container(
          padding: EdgeInsets.all(40), child: Column(children: headChildren)),
      Padding(
    ...
    return Scaffold(backgroundColor: color, body: ListView(children: children));
  }
}
