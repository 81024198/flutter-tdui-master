...
class TdProgress extends StatefulWidget {
  ...
  @override
  TdProgressState createState() => TdProgressState();
}

class TdProgressState extends State<TdProgress>
  ...
  void didChangeDependencies() {
    ...
    _higDecoration = (widget.higDecoration == null
        ? BoxDecoration(color: TdUi.getTheme(context).primaryColor)
  ...
  @override
  void didUpdateWidget(TdProgress oldWidget) {
