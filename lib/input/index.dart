...
class TdInput extends StatefulWidget {
  ...
  @override
  TdInputState createState() => TdInputState();
}

class TdInputState extends State<TdInput> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget clearWidget = GestureDetector(
        onTap: _clearValue,
        child: Container(
            child: Icon(TdIcons.clear, color: Color(0xffc8c9cc), size: 25.0)));
    ...
    Widget footer;
    if (widget.clearable) {
      footer = controller.text.length > 0 ? clearWidget : Container();
    } else {
