...
class PreviewState extends State<Preview> {
  ...
  void initState() {
    super.initState();
    _index = widget.defaultIndex == null ? 0 : widget.defaultIndex!;
    // PageController
  ...
  Widget renderIndicators() {
    ...
    int length = widget.images == null ? 0 : widget.images!.length;
    ...
    Widget child = PageView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return GestureDetector(
              onTap: () {
                if (widget.maskClick != null) widget.maskClick!();
              },
              child: DecoratedBox(
                  ...
                  child: Padding(
                      ...
                      child:
                          Align(child: Image.network(widget.images![index])))));
        });
