...
class TdChecklist extends StatefulWidget {
  // 选项
  final List<TdChecklistItem> children;
  // value
...
class _ChecklistState extends State<TdChecklist> {
    ...
    return Container(
        ...
        child: isChecked
            ? Align(
                ...
                child: Icon(TdIcons.hook, color: Colors.white, size: 16))
            : null);
  }
