...
final Widget _divider =
    Expanded(flex: 1, child: Divider(height: 1.0, color: Color(0xffE5E5E5)));
// 文字padding
final double _textPadding = 12.0;

class TdLoadmore extends StatefulWidget {
  final bool loading;
  ...
  @override
  TdLoadmoreState createState() => TdLoadmoreState();
}

class TdLoadmoreState extends State<TdLoadmore> {
  @override
  Widget build(BuildContext context) {
    final Widget loadingWidget =
      ...
      Padding(
          ...
          child: Rotating(Icon(TdIcons.loading, size: 20.0))),
      DefaultTextStyle(
    ...
    // moreChild
    final Widget moreChild = Row(children: [
      _divider,
      DecoratedBox(
