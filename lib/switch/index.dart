...
class TdSwitch extends StatefulWidget {
  ...
  @override
  TdSwitchState createState() => TdSwitchState();
}

class TdSwitchState extends State<TdSwitch> with TickerProviderStateMixin {
  late double _width;
  late double _height;
  late Color color;
  bool _open = false;
  ...
  void didChangeDependencies() {
    ...
    color = widget.color == null
        ? TdUi.getTheme(context).primaryColor
        : widget.color!;
    // 初始化动画
    initAnimate();
  }
  ...
  @override
  void didUpdateWidget(TdSwitch oldWidget) {
